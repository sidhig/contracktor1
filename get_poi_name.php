...
<tr><td style='padding: 5px;'><strong>Geofence: </strong><span style="color:red;">*</span></td><th><select id="geofence"  style="width:100%" >
  ...
  <tr>
    <th colspan="2" style="text-align: center;">
		...
		<input type="button" value="Close" onclick='$("#poi_table,#poi_dl").empty();$("#view_poi").show();$("#poi_type,#poi_name").val("");' >
		<input style="" type="button" value="Edit Location On Map" onclick="get_latlong();">
...
<tr><td style='padding: 5px;'><strong>State: </strong></td><th><input id="state_txt" placeholder="State" value="" style="width:100%"></th></tr>
<tr><td style='padding: 5px;'><strong>Zip: </strong></td><th><input id="zip_txt" placeholder="Zip" value="" style="width:100%"></th></tr>
<tr><td style='padding: 5px;'><strong>Latitude: </strong><span style="color:red;">*</span></td><th><input id="lati_txt" placeholder="Latitude" value="" style="width:100%"></th></tr>
<tr><td style='padding: 5px;'><strong>Longitude: </strong><span style="color:red;">*</span></td><th><input id="longi_txt" value="" placeholder="Longitude" style="width:100%"></th></tr>
<tr><td style='padding: 5px;'><strong>Geofence: </strong><span style="color:red;">*</span></td><th><select id="geofence" style="width:100%" >
			<option value="" ></option>
  ...
  <tr>
    <th colspan="2" style="text-align: center;">
        <input class="poi_add_new" type="button" value="Add" onclick="add_poi();"> 
        <input class="" type="button" value="View on Map" onclick="get_latlong();"> 
        <input type="reset" value="Clear" onclick="poi_clear();" style="margin-top:2%"> 
        <input type="button" value="Close" onclick='$("#poi_table").empty();$("#menu").show();$("#view_poi").hide();' >
    </th>
</tr>
