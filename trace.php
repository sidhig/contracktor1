  ...
  <div style='background:white; font-size: 1.2rem;width: 50%; border-radius: 15px; padding: 5px; border: 2px solid #969090;color:black;'>
 <form id='new_tracker_form' name="new_tracker_form">
        ...
        <tr>
            ...
            <td><input type='hidden' name='qry_type' value='new'>
              <input id="trackername" name="trackername" type="text" class="intp " style="background-color:#D3D3D3;" placeholder="Tracker Name">
            </td>
        </tr>
        <tr>
              <td><strong class="stg">Driver Name:</strong></td>
              <td><input id="drivername" name="drivername" type="text" class="intp" placeholder="Driver Name">
              </td>
        </tr>
        <tr>
              <td><strong class="stg">Driver Phone:</strong></td>
              <td><input id="driverphone" name="driverphone" type="number" class="intp" placeholder="Driver Phone">
              </td>
        </tr>
        <tr> 
              <td ><strong class="stg">Tracker IMEI:</strong></td>
              <td><input id="trackerimei" name="trackerimei"  type="text" class="intp" style="background-color:#D3D3D3;" placeholder="Tracker IMEI">
              </td>
        </tr>
         <tr>      
          ...
          <tr>
            ...
            <td><input id="trackerphone" name="trackerphone" type="number" class="intp" style="background-color:#D3D3D3;" placeholder="Tracker Phone">
            </td>
        </tr>
        <tr>
             <td><strong class="stg">Tag #:</strong></td>
             <td><input id="tag" name="tag" type="text" class="intp" placeholder="Tag #">
              </td>
        </tr>
        <tr>
              <td><strong class="stg">Odometer:</strong></td>
              <td><input id="odometer" name="odometer" type="text" class="intp" placeholder="Odometer">
              </td>
        </tr> 
        <tr>
