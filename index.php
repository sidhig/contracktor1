...
//echo explode(",", $_POST['cmpnyname'])[0];

  $_SESSION["db_name"] = explode(",", $_POST['cmpnyname'])[0];
  $_SESSION["Account"] = explode(",", $_POST["Account"])[1];
 //echo $_SESSION["db_name"];exit();
// echo $_SESSION["Account"];exit();
    ...
    <div class="login">
      ...
      <input id="comp_name" type="text"  name="CompanyName" list="CompanyName" placeholder="Company Name"  >
          ...
          $res = $con->query("select * from tbl_company where isactive = 1");
               ...
               {
               ?><option data-xyz="<?=$cam->DBname.",".$cam->Account?>" value="<?=$cam->CompanyName?>" >
